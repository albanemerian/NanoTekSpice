...
nts::Or::Or(std::string const &value) {
    _name = value;
    MAX_PIN = 3;
...
size_t nts::Or::getMaxPin() const {
    return 3;
}

nts::Tristate nts::Or::getPrevValue() const {
    return nts::Tristate::Undefined;
}

std::string nts::Or::getPinType(std::size_t pin) {
    return _pins[pin]._type;
}

nts::Tristate nts::Or::getPinState(std::size_t pin) {
    return _pins[pin]._value;
}

nts::Tristate nts::Or::computes(std::size_t pin1, std::size_t pin2, std::size_t out) {
    return nts::Or_logic(getPinState(pin1), getPinState(pin2), out);
}

nts::Tristate nts::Or::getNextValue() const {
    return nts::Tristate::Undefined;
}
...
void nts::Or::setPinState(std::size_t pin, nts::Tristate state) {
